...
- Next task: prepare the minimal downstream prediction experiment using frozen splits and generated targets, without revisiting target binning or model selection prematurely.
